...
func (l *DailyWriter) Write(p []byte) (n int, err error) {
	l.mu.Lock()
	defer l.mu.Unlock()
...
func (l *DailyWriter) Close() error {
	l.mu.Lock()
	defer l.mu.Unlock()
	return l.close()
}

func (l *DailyWriter) Rotate() error {
	l.mu.Lock()
	defer l.mu.Unlock()
	return l.rotate()
}
...
func (l *DailyWriter) oldLogFiles() ([]logInfo, error) {
...
func (l *DailyWriter) timeFromName(filename, prefix, ext string) (time.Time, error) {
...
func (l *DailyWriter) prefixAndExt() (prefix, ext string) {
...
func (l *DailyWriter) millRunOnce() error {
...
func (l *DailyWriter) millRun() {
	for _ = range l.millCh {
		_ = l.millRunOnce()
	}
}

func (l *DailyWriter) mill() {
	l.startMill.Do(func() {
...
func (l *DailyWriter) openNew() error {
	name := l.filename()
...
func (l *DailyWriter) openExistingOrNew(writeLen int) error {
...
func (l *DailyWriter) filename() string {
